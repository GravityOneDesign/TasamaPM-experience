...
import { PmoCalendarPlanDrawerComponent } from './pmo-calendar-plan-drawer.component';
...
@Component({
  ...
  standalone: true,
  imports: [PmConsoleIconComponent, PmoCalendarPlanDrawerComponent],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <app-pmo-calendar-plan-drawer
...
export class PmoCalendarGovernanceMeetingDrawerComponent {
