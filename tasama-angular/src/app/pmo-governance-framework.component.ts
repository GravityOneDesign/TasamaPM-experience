...
@Component({
  ...
  styles: [`
    ...
    /* Make the Framework Settings configuration tabs horizontally scrollable
       when the viewport is too narrow to show them all. Scoped to this page
       only (via :host ::ng-deep) so other usages of the shared mode-tabs are
       unaffected. The scrollbar only appears when the tabs overflow. */
    :host ::ng-deep .project-modebar-inline {
      overflow-x: auto;
      overflow-y: hidden;
      max-width: 100%;
      ...
      scrollbar-width: thin;
      scrollbar-color: #cfdefd transparent;
      /* Align tabs to the start so overflow extends to the right (reachable by
         scrolling) instead of to the left (clipped and unreachable). */
      justify-content: flex-start;
      align-self: stretch;
    }
    :host ::ng-deep .project-modebar-inline::-webkit-scrollbar {
      height: 6px;
    }
    :host ::ng-deep .project-modebar-inline::-webkit-scrollbar-track {
      background: transparent;
    }
    :host ::ng-deep .project-modebar-inline::-webkit-scrollbar-thumb {
      background: #cfdefd;
      border-radius: 999px;
    }
    :host ::ng-deep .project-modebar-inline::-webkit-scrollbar-thumb:hover {
      background: #10069f;
    }
    :host ::ng-deep .project-modebar-inline .project-mode-toggle {
      flex: 0 0 auto;
    }
  `]
})
