...
/**
 * Portfolio Manager "My Actions" card.
 * Copy of Project Manager card design (isolated to avoid cross-persona impact).
 */
@Component({
  selector: 'app-portfolio-manager-action-card',
  standalone: true,
  ...
  styles: [
    `
      ...
      .pm-card-tag[data-event-type='Governance committee'],
...
export class PortfolioManagerActionCardComponent {
