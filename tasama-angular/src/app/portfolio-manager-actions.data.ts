...
export interface PortfolioActionItem {
  ...
  kind: 'report' | 'risk' | 'benefit' | 'milestone' | 'task' | 'dependency' | 'plan' | 'change' | 'governance' | 'plans' | 'status-reports' | 'change-requests' | 'benefits'; // mapped for filters
  tone: 'green' | 'red' | 'blue' | 'neutral' | 'plans' | 'governance' | 'status-reports' | 'change-requests' | 'benefits'; // tone color class
...
export const portfolioBoardFilters: PortfolioBoardFilter[] = [
  ...
  { id: 'governance', label: 'Governance & Committees', icon: 'dependencies' },
  { id: 'status-reports', label: 'Status Reports', icon: 'checklist' },
];
...
export const portfolioActionItems: PortfolioActionItem[] = [
  // Wed 6 May
  {
    id: 'ACT-01',
    date: '2026-05-06',
    label: 'Verify Vision 2030 benefit evidence',
    project: 'Vision 2030',
    targetType: 'project',
    type: 'Verify Benefit',
    kind: 'benefits',
  ...
  },
  {
    id: 'ACT-02',
    date: '2026-05-06',
    label: 'Approve NEOM change request',
  ...
  // Thu 7 May
  {
    id: 'ACT-03',
    date: '2026-05-07',
    label: 'Review Smart City milestone plan',
  ...
  // Fri 8 May
  {
    id: 'ACT-04',
    date: '2026-05-08',
    label: 'Review UAE research map plan',
  ...
  },
  {
    id: 'ACT-05',
    date: '2026-05-08',
    label: 'Governance Board monthly meeting',
    project: 'Vision 2030',
    targetType: 'project',
    type: 'Governance Board',
    kind: 'governance',
    tone: 'governance',
    owner: 'SA',
    meta: 'Done',
  ...
  // Sun 17 May
  {
    id: 'ACT-06',
    date: '2026-05-17',
    label: 'Steering Committee weekly review',
    project: 'NEOM Integration',
    targetType: 'project',
    type: 'Governance Board',
    kind: 'governance',
  ...
  },
  {
    id: 'ACT-07',
    date: '2026-05-17',
    label: 'Submit weekly status report',
    project: 'Vision 2030',
    targetType: 'project',
    type: 'Submit Report',
    kind: 'status-reports',
  ...
  },
  {
    id: 'ACT-08',
    date: '2026-05-17',
    label: 'Review schedule baseline',
    project: 'Smart City Alpha',
    targetType: 'project',
    type: 'Review Plan',
    kind: 'plans',
  ...
  },
  {
    id: 'ACT-10',
    date: '2026-05-19',
    label: 'Submit monthly status report',
    project: 'UAE Research Map',
    targetType: 'project',
    type: 'Submit Report',
    kind: 'status-reports',
  ...
  // Wed 20 May
  {
    id: 'ACT-11',
    date: '2026-05-20',
    label: 'Approve budget adjustment',
    project: 'Smart City Alpha',
    targetType: 'project',
    type: 'Review Change Request',
    kind: 'change-requests',
  ...
  },
  {
    id: 'ACT-12',
    date: '2026-05-20',
    label: 'Governance board checkpoint',
    project: 'NEOM Integration',
    targetType: 'project',
    type: 'Governance Board',
    kind: 'governance',
  ...
  // Mon 25 May
  {
    id: 'ACT-13',
    date: '2026-05-25',
    label: 'Review highlight status report',
    project: 'NEOM Integration',
    targetType: 'project',
    type: 'Submit Report',
    kind: 'status-reports',
  ...
  },
  {
    id: 'ACT-14',
    date: '2026-05-25',
    label: 'Review committee evidence packs',
    project: 'Vision 2030',
    targetType: 'project',
    type: 'Governance Board',
    kind: 'governance',
  ...
  // Tue 26 May (Today in Image 2)
  {
    id: 'ACT-15',
    date: '2026-05-26',
    label: 'Verify Smart City benefit realization',
    project: 'Smart City Alpha',
    targetType: 'project',
    type: 'Verify Benefit',
    kind: 'benefits',
  ...
  },
  {
    id: 'ACT-16',
    date: '2026-05-26',
    label: 'Review Vision 2030 program schedule',
    project: 'Vision 2030',
    targetType: 'project',
    type: 'Review Plan',
    kind: 'plans',
  ...
  // Thu 28 May
  {
    id: 'ACT-18',
    date: '2026-05-28',
    label: 'Review integration plans',
    project: 'NEOM Integration',
    targetType: 'project',
    type: 'Review Plan',
    kind: 'plans',
  ...
  },
  {
    id: 'ACT-19',
    date: '2026-05-28',
    label: 'Approve scope adjustment',
    project: 'Vision 2030',
    targetType: 'project',
    type: 'Review Change Request',
    kind: 'change-requests',
  ...
  // Fri 29 May
  {
    id: 'ACT-20',
    date: '2026-05-29',
    label: 'Review research schedule',
    project: 'UAE Research Map',
    targetType: 'project',
    type: 'Review Plan',
    kind: 'plans',
  ...
  },
  {
    id: 'ACT-22',
    date: '2026-05-29',
    label: 'Ad-hoc steering committee',
    project: 'Vision 2030',
    targetType: 'project',
    type: 'Governance Board',
    kind: 'governance',
  ...
  // Sat 30 May
  {
    id: 'ACT-23',
    date: '2026-05-30',
    label: 'Confirm benefit documentation',
    project: 'NEOM Integration',
    targetType: 'project',
    type: 'Verify Benefit',
    kind: 'benefits',
  ...
  },
  {
    id: 'ACT-24',
    date: '2026-05-30',
    label: 'Monthly committee report',
    project: 'Vision 2030',
    targetType: 'project',
    type: 'Governance Board',
    kind: 'governance',
  ...
  // Sun 31 May
  {
    id: 'ACT-25',
    date: '2026-05-31',
    label: 'End of month committee review',
    project: 'UAE Research Map',
    targetType: 'project',
    type: 'Governance Board',
    kind: 'governance',
  ...
  },
  {
    id: 'ACT-26',
    date: '2026-05-31',
    label: 'Final change request batch',
    project: 'Smart City Alpha',
    targetType: 'project',
    type: 'Review Change Request',
    kind: 'change-requests',
  ...
  },
  {
    id: 'ACT-27',
    date: '2026-05-31',
    label: 'Submit final status report',
    project: 'Vision 2030',
    targetType: 'project',
    type: 'Submit Report',
    kind: 'status-reports',
