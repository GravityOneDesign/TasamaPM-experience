(function () {
let tasamaConsoleCleanup = null;

window.TasamaPmConsole = {
  mount() {
    if (typeof tasamaConsoleCleanup === "function") {
...
document.addEventListener("keydown", tasamaConsoleKeydownHandler);
